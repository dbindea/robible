 ...
 *
 * «Introducere» fue un paso propio del 10 al 15 sep 2026. Hoy se escribe dentro
 * de «Dezvoltare», en la misma pantalla y antes de los puntos: sigue estando
 * antes que ellos —al revés de lo que enseña el curso, que la deja para el
 * final— pero deja de ser una pantalla aparte. Ver la nota de `STEPS` en
 * `sermon-content.service.js`.
 */
const PASOS = [
  ...
  ['Dezvoltare', 'Începe cu introducerea — fraza de început și aplicațiile introductive, scrise acum, cu ideea și structura deja clare. Apoi fiecare diviziune se dezvoltă prin trei secțiuni: explicarea și aplicarea sunt obligatorii, ilustrarea este opțională.'],
