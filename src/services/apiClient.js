...
const ERROR_KEYS = {
  ...
  memorization_already_exists: 'auth.errors.memorization_already_exists',
  memorization_not_found: 'auth.errors.memorization_not_found',
  invalid_stage: 'auth.errors.invalid_stage',
  invalid_due_date: 'auth.errors.invalid_due_date',
