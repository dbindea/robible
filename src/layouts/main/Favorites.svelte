...
<style lang="scss">
  ...
  :global(html[data-theme='dark']) .favorite-item {
    ...
    color: #e5edf3;
    &:hover { background: rgb(45 150 205 / 14%); border-color: #7ec8e3; }
  }
  :global(html[data-theme='dark']) .favorites-group__title { color: #7ec8e3; border-bottom-color: rgb(126 200 227 / 22%); }
